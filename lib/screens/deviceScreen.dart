...
class _DeviceScreenState extends State<DeviceScreen> {
  // flutterBlue
  final String SERVICE_UUID = '6E400001-B5A3-F393-E0A9-E50E24DCCA9E'; // PUT HERE THE SERVICE UUID
  final String CHARACTERISTIC_UUID = ''; // CHARACTERISTIC UUID GOES HERE
